...
import { useGenerateSuggestionsMutation, useRemediationMutation } from '../hooks/mutations/useRemediationMutations'
import type { AISuggestion } from '../types/remediation'
